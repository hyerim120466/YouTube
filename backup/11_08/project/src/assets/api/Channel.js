...
export const Channel = {
    ...
    KBS_Joy: {
        ...
        Movies: [
                ...
                movie_comments: [
                    {
                        ...
                        comment_body: '공부안하고 딴짓할때 수호령이 뒤통수 때려줬음 좋겠다..',
            ...
            {
                movie_id: 932848,
                movie_title: '스스로도 풀지 못한.. 진짜 무속인의 마음속 고민 [무엇이든 물어보살]',
                movie_body:
            ...
            },
            {
                ...
                movie_body: "'아내가 제 절친과 바람났습니다..' 초보 싱글 대디의 안타까운 고민🤦‍♂️",
                movie_image:
                ...
                movie_comments: [
                    {
                        comment_id: 165265,
                        comment_body: '좀 잔인한 얘기지만 아기도 유전자 검사 한번 해 보길..',
                        comment_user_id: 'test',
    ...
    LIJULIKE: {
        ...
        Movies: [
            ...
            },
            {
                ...
                movie_body: '드디어 제 동생 현주와 제 친구 태성이의 결혼식을 공개해요 !',
                movie_image:
    ...
    Highfiction: {
        ...
        Movies: [
            ...
            },
            {
                ...
                movie_body: '안녕하세요 스톡커입니다 다시 돌아온 헬스장편 재밌게 봐주세요~!!',
                movie_image:
    ...
    Beginagain: {
        ...
        channel_introduction: 'JTBC의 힐링 음악 예능 [비긴어게인] 공식 채널입니다🎵',
        // 채널의 구독자 수
        ...
        Movies: [
            {
                ...
                movie_comments: [
                    {
                        comment_id: 894448,
                        comment_body: '하이는 본인을 이기는구나,, 라이브가 음원을 압살해버리네',
                        comment_user_id: 'test',
            ...
            },
            {
                ...
                movie_body: '이수현x정승환의 ′어떻게 이별까지 사랑하겠어， 널 사랑하는 거지′♪',
                movie_image:
            ...
            },
            {
                ...
                movie_body: "비긴어게인 코리아 '길' 풀버전 버스킹 현장이 눈물바다가 된 사연은?!",
                movie_image:
    ...
    G_Movie: {
        ...
        Movies: [
            {
                movie_id: 98384321,
                movie_title: '수갑채워놨는데 남편이 심장마비로 사망하면 벌어지는 대참사',
            ...
            {
                movie_id: 907429,
                movie_title: '제목 따위 필요 없는, 내 인생 최고의 드라마 《이태원클라쓰》',
    ...
    ultraTasteDiary: {
        ...
        channel_introduction: '귀찮음과 시간이 만들어내는 예술 비즈니스 : utdcook@gmail.com',
        // 채널의 구독자 수
        ...
        Movies: [
            ...
            },
            {
                ...
                movie_comments: [
                    {
                        comment_id: 348943,
                        comment_body: '결국 흑백요리사에도 등장해버린 미소 매쉬드 머시라카노..',
        ...
        Movies: [
            ...
            },
            {
                ...
                movie_comments: [
                    {
                        comment_id: 784235,
                        comment_body: '꼬꼬무가 끝날 일은 없겟다 ... 하도 많은 사건이 나와서...',
                        comment_user_id: 'test',
    ...
    ootbstudio: {
        ...
        Movies: [
            ...
            },
            {
                // 4-한국외대 아랍어과
                movie_id: 8974284,
                movie_title: '미안하면 씨X 하는 학과 [한국외대 아랍어과] | 전과자 ep.67 [EN]',
    ...
    SBSANIMAL: {
        ...
        Movies: [
            ...
            },
            {
                // 2 - 먼치킨
                movie_id: 990159,
                movie_title: '나는 태어난 지 30일 된 먼치킨 새끼다 [애니멀봐 나새끼 26호]',
                movie_body:
        ...
        Movies: [
            {
                ...
                movie_comments: [
                    {
                        comment_id: 116101,
                        comment_body: '좋았어! 이제 집만 넓어지면 되겠어요!!😂ㅋㅋㅋㅋㅋㅋㅋ',
                        comment_user_id: 'test',
            ...
            },
            {
                ...
                movie_comments: [
                    {
                        comment_id: 111504,
                        comment_body: '유익한정보감사해요 거실카펫.건식욕조러그두추천해주셈',
                        comment_user_id: 'test',
    ...
    mamu_vlog: {
        ...
        channel_introduction: 'instagram | @mma_muu email | morningood9922@gmail.com',
        // 채널의 구독자 수
    ...
    moozzi: {
        ...
        Movies: [
            ...
            {
                movie_id: 659056,
                movie_title: 'No 마스카라‼️ 요청 폭발한 내추럴 아이 메이크업 (진짜 10분컷)',
                movie_body:
            ...
            {
                movie_id: 305135,
                movie_title: '무쌍이 따라해보는 카즈하,아린님 st 토끼상🐰 메이크업 (신상템 가득🔥)',
                movie_body:
                ...
                movie_comments: [
                    {
                        comment_id: 4604648,
                        comment_body: '무찌님 덕에 누드밀크티 사고 인생 메이크업 완성했습니다..❤️‍🔥 ',
                        comment_user_id: 'test',
        ...
        Movies: [
            ...
            },
            {
                ...
                movie_comments: [
                    {
                        comment_id: 198315,
                        comment_body: '아니 썸넬 미쳤냐고요 깜이가 놀이;;; 미모베리 미가 쳤어요;;;',
                        comment_user_id: 'test',
