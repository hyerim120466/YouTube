...
const Channel_video = () => {
    ...
    <ChannelVideoWrap>
        <div className="channel_video_tab">
            <button className={`sort_btn ${activeSort === 'latest' ? 'active' : ''}`} 
                    onClick={() => setActiveSort('latest')}> 최신순 </button>
            <button className={`sort_btn ${activeSort === 'popular' ? 'active' : ''}`} 
                    onClick={() => setActiveSort('popular')}> 인기순 </button>
            <button className={`sort_btn ${activeSort === 'date' ? 'active' : ''}`} 
                    onClick={() => setActiveSort('date')}> 날짜순 </button>
        </div>
